...
for(var x = 0 ; x< get_result_users_nom_1_array_2.length ; x++){



 
  get_rp_array_2_sort.push({id:x, val:get_rp_array_2[x]}) ;
  get_vent_array_2_sort.push({id:x, val:get_vent_array_2[x]}) ;
  get_result_users_perf_array_2_sort.push({id:x, val:get_result_users_perf_array_2[x]}) ;
  get_result_users_nom_1_array_2_sort.push({id:x, val:get_result_users_nom_1_array_2[x]}) ;

  get_result_users_nom_2_array_2_sort.push({id:x, val:get_result_users_nom_2_array_2[x]}) ;
  get_result_users_nom_3_array_2_sort.push({id:x, val:get_result_users_nom_3_array_2[x]}) ;
  get_result_users_nom_4_array_2_sort.push({id:x, val:get_result_users_nom_4_array_2[x]}) ;
  get_users_nationality_array_2_sort.push({id:x, val:get_users_nationality_array_2[x]}) ;
  get_club_nom_complet_array_2_sort.push({id:x, val:get_club_nom_complet_array_2[x]}) ;

  get_club_departement_array_2_sort.push({id:x, val:get_club_departement_array_2[x]}) ;
  get_club_region_array_2_sort.push({id:x, val:get_club_region_array_2[x]}) ;
  get_cat_array_2_sort.push({id:x, val:get_cat_array_2[x]}) ;
  get_users_naissance_array_2_sort.push({id:x, val:get_users_naissance_array_2[x]}) ;
  get_result_date_perf_array_2_sort.push({id:x, val:get_result_date_perf_array_2[x]}) ;

  get_result_villes_nom_array_2_sort.push({id:x, val:get_result_villes_nom_array_2[x]}) ;
  epreuve_sex_array_2_sort.push({id:x, val:epreuve_sex_array_2[x]}) ;
  get_users_nom_complet_array_sort.push({id:x, val:get_users_nom_complet_array[x]}) ;
  info_all_array_click_sort.push({id:x, val:info_all_array_click[x]}) ;
  info_all_array_ip_sort.push({id:x, val:info_all_array_ip[x]}) ;

  info_all_array_src_name_sort.push({id:x, val:info_all_array_src_name[x]}) ;
  window_location_href_sort.push({id:x, val:window_location_href[x]}) ;
  get_epreuve_nom_complet_sort.push({id:x, val:get_epreuve_nom_complet[x]}) ;
  reg_date_sort.push({id:x, val:reg_date[x]}) ;
...
//console.log(get_result_users_nom_1_array_2_sort) ; 
/*
console.log(get_result_users_nom_2_array_2_sort) ; 
console.log(get_result_users_nom_3_array_2_sort) ;

console.log(get_result_users_nom_4_array_2_sort) ; 
console.log(get_users_nationality_array_2_sort) ;
*/

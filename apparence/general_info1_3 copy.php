...
<div class="progress">
  <div class="progress-bar" role="progressbar" aria-label="Basic example" aria-valuenow="0" style="width: 0%" aria-valuemin="0" aria-valuemax="100" id="tab_f">F</div>
</div>
<div class="progress">
  <div class="progress-bar" role="progressbar" aria-label="Basic example" style="width: 0%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" id="tab_m">H</div>
</div>
...
*/              
              ...
              document.getElementById("n3").innerHTML=parseInt((tab_sex_m/(tab_sex_f+tab_sex_m))*100, 10)+'% <img width="30" height="30" src="https://img.icons8.com/fluency-systems-regular/30/male.png" alt="male"/>' ;  
              document.getElementById("n4").innerHTML=parseInt((tab_sex_f/(tab_sex_f+tab_sex_m))*100,10)+'% <img width="30" height="30" src="https://img.icons8.com/ios/30/female.png" alt="female"/>';  
              ...
              document.getElementById("tab_m").style="width:"+pourcentage_n1+"%"; 
              document.getElementById("tab_f").style="width:"+pourcentage_n4+"%"; 
              ...
              console.log("tab_lancers_nombre : " + tab_lancers_nombre) ; 
              console.log("tab_demi_fond_nombre : " + tab_demi_fond_nombre) ; 
              console.log("tab_sprint_nombre : " + tab_sprint_nombre) ; 
              console.log("tab_font_nombre : " + tab_font_nombre) ; 
              console.log("tab_sex_m : " + tab_sex_m) ; 
              console.log("tab_sex_f : " + tab_sex_f) ; 

<?php
/**
 * Js.php — Classe JavaScript d'envoi de donnees AJAX / JavaScript AJAX data sending class
 * FR: Classe JavaScript Information pour envoyer des donnees via XMLHttpRequest en methode POST
 * EN: JavaScript Information class to send data via XMLHttpRequest using POST method
 */
?>
<script>
class Information {
